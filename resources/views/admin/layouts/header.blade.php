                        ...
                        <div class="p-v-10">
                            ...
                            <ul class="list-media">
                                ...
                                <li class="list-item">
                                    <a href="javascript:void(0);" class="conversation-toggler media-hover p-h-20">
                                        <div class="media-img">
                                            <img src="{{ asset('assets/admin/images/avatars/thumb-5.jpg') }}" alt="">
                                        </div>
                                        <div class="info">
...
{{--            </li>--}}
            <li class="user-profile dropdown dropdown-animated scale-left">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img class="profile-img img-fluid" src="{{ trim(str_replace('public/', '', asset(Auth::user()->avatar))) }}" alt="avatar">
                </a>
                    ...
                    <li>
                        <ul class="list-media">
                            <li class="list-item p-15">
                                <div class="media-img">
                                    <img src="{{ trim(str_replace('public/', '', asset(Auth::user()->avatar))) }}" alt="">
                                </div>
                                <div class="info">
